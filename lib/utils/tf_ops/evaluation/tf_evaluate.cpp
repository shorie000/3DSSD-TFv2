...
class EvaluateOp: public OpKernel{
    public:
        ...
        void Compute(OpKernelContext * context) override {
            ...
            auto names_flat = names_tensor.flat<tstring>();
            const tstring *names = &(names_flat(0));

            string names_str[n_images];
            ...
            // const string names_str = names[0];
            ...
            evaluate_cpu(detections, names_str, numlist, n_images, precision_image, aos_image, precision_ground, aos_ground, precision_3d, aos_3d);
        }
};
