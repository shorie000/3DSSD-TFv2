...
def get_learning_rate(batch):
    ...
    learning_rate = tf.compat.v1.train.piecewise_constant(batch, steps, values).func(batch)
...
def get_bn_decay(batch):
    ...
    bn_momentum = tf.compat.v1.train.piecewise_constant(batch, steps, values).func(batch)
