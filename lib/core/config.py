...
# 6: scope
#################################################
__C.MODEL.NETWORK.FIRST_STAGE.HEAD = [
    [[6], [6], 'conv1d', [128, ], True, 'Det', 'detection_head']]
...
# 8: scope
#################################################
__C.MODEL.NETWORK.FIRST_STAGE.POINTS_POOLER = ['RegionPool', [
    'mask', 'dist'], [128], 512, 1.0, [6, 6, 6, 10], [128], True, 'roi_pool']
...
# 4: scope
#################################################
__C.MODEL.NETWORK.SECOND_STAGE.HEAD = [
    [6], [6], [128, ], True, 'detection_head']
...
__C.MODEL.FIRST_STAGE.MULTI_HEAD_DISTRUBUTE = [['car'], ['construction_vehicle', 'truck'], [
    'bus', 'trailer'], ['barrier'], ['motorcycle', 'bicycle'], ['pedestrian', 'traffic_cone']]
# Sigmoid or Softmax
...
__C.MODEL.SECOND_STAGE.MULTI_HEAD_DISTRUBUTE = [['car'], ['construction_vehicle', 'truck'], [
    'bus', 'trailer'], ['barrier'], ['motorcycle', 'bicycle'], ['pedestrian', 'traffic_cone']]
# Sigmoid or Softmax
